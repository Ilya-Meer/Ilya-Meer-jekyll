...
var setup = function() {
	...
	loader.load('../../assets/fonts/raleway_404.json', function (font) {
		var geometry = new THREE.TextGeometry('404', { font: font, size: 75, height: 20, curveSegments: 12, bevelEnabled: true, bevelThickness: 9, bevelSize: 2, bevelSegments: 5 });
		geometry.center();

		var material = new THREE.MeshPhongMaterial({ color: 0x000, shininess: 500 });
